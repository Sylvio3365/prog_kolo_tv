ALTER TABLE KOLOTV1203.MOUVEMENTCAISSE ADD (
...
CREATE
OR REPLACE VIEW MOUVEMENTCAISSECPL AS
SELECT
    m.ID,
    m.DESIGNATION,
    m.IDCAISSE,
    ...
    m.NUMERO,
    CASE
        WHEN m.ETAT = 0 THEN 'ANNULEE'
        WHEN m.ETAT = 1 THEN 'CREE'
        WHEN m.ETAT = 11 THEN 'VALIDEE'
    END AS ETATLIB,
    vd.IDVENTE,
    m.IDORIGINE,
    m.idtiers,
