ALTER TABLE BONDECOMMANDE_CLIENT ADD echeance VARCHAR(500);

ALTER TABLE BONDECOMMANDE_CLIENT ADD modereglement VARCHAR(500);

CREATE
OR REPLACE FORCE VIEW "BC_CLIENT_FORM" (
    "ID",
    "DATY",
    "ETAT",
    "REMARQUE",
...
SELECT
    ...
    bc.modereglement
FROM
    BONDECOMMANDE_CLIENT bc;

ALTER TABLE BONDECOMMANDE_CLIENT_FILLE ADD reference VARCHAR(500);

CREATE
OR REPLACE FORCE VIEW "INSERTIONBCFILLE" (
    "ID",
    "PRODUIT",
    "IDBC",
    "QUANTITE",
...
SELECT
    ...
    p.reference
FROM
    BONDECOMMANDE_CLIENT_FILLE p;

CREATE
OR REPLACE FORCE VIEW "BC_CLIENT_FILLE_CPL_LIB2" (
    "ID",
    "PRODUIT",
    "IDBC",
    "QUANTITE",
...
CREATE
OR REPLACE FORCE VIEW "BONDECOMMANDE_CLIENT_CPL" (
    "ID",
    "DATY",
    "ETAT",
    "REMARQUE",
