...
public class ComptaSousEcriture extends ClassFille {
    ...
    public void setJournal(String journal) throws Exception {
        ...
        if (getMode().compareToIgnoreCase("modif") == 0) {
            if (journal == null || journal.compareToIgnoreCase("") == 0)
                throw new Exception("Journal vide");
        }
    ...
    public ComptaSousEcriture(String id, String compte, double debit, double credit, String remarque,
            String libellePiece, String ecriture, String ref_engag, String compte_a) throws Exception {
    ...
    public ComptaSousEcriture(String compte, double debit, double credit, String remarque, String libellePiece,
            String ecriture, String ref_engag, String compte_a) throws Exception {
        super.setNomTable("compta_sous_ecriture");
        this.setLiaisonMere("idMere");
        this.setNomClasseMere("mg.cnaps.compta.ComptaEcriture");
        this.setCompte(compte);
    ...
    public ComptaSousEcriture(String compte, double debit, double credit, String remarque, String libellePiece,
            String ecriture, String ref_engag, String compte_a, String folio, String analytique) throws Exception {
        super.setNomTable("compta_sous_ecriture");
        this.setLiaisonMere("idMere");
        this.setNomClasseMere("mg.cnaps.compta.ComptaEcriture");
        this.setCompte(compte);
    ...
    public ComptaSousEcriture(String compte, double debit, double credit, String remarque, String libellePiece,
            String ecriture, String ref_engag) throws Exception {
        super.setNomTable("compta_sous_ecriture");
        this.setLiaisonMere("idMere");
        this.setNomClasseMere("mg.cnaps.compta.ComptaEcriture");
        this.setCompte(compte);
    ...
    public ComptaSousEcriture(String compte, String tiers, double debit, double credit, String remarque,
            String libellePiece, String ecriture, String ref_engag) throws Exception {
        super.setNomTable("compta_sous_ecriture");
        this.setLiaisonMere("idMere");
        this.setNomClasseMere("mg.cnaps.compta.ComptaEcriture");
        this.setCompte(compte);
    ...
    public ComptaSousEcriture(String compte, double debit, double credit, String remarque, String libellePiece,
            String reference_engagement, String compte_aux, String lettrage, String journal, String exercice,
            String folio, Date daty, String analytique, String source) throws Exception {
        super.setNomTable("compta_sous_ecriture");
        this.setCompte(compte);
        this.setDebit(debit);
        this.setCredit(credit);
    ...
    private void checkDebitCredit() throws Exception {
        ...
        if (this.credit > 0) {
            if (this.debit > 0) {
                throw new Exception(
                        "Vous devez saisir une valeur dans le champ debit ou une valeur dans le champ credit");
            }
        }
    }
    ...
    public void testEtatMoisExercice(String texte, Connection c) throws Exception {
        try {
            ...
            ClotureMoisAnnee[] cl = (ClotureMoisAnnee[]) CGenUtil.rechercher(new ClotureMoisAnnee(), null, null, c,
                    " AND MOIS = " + mois + " AND ANNEE=" + exercice);
            String m = Utilitaire.nbToMois(mois);
            if (cl.length > 0) {
                if (cl[0].getEtat() == 9) {
                    throw new Exception(
                            "IMPOSSIBLE " + texte + ". MOIS " + m.toUpperCase() + " " + exercice + " CLOTURE");
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    /*
     * @Override
     * public int insertToTableWithHisto(String refUser, java.sql.Connection
     * c)throws Exception {
     * 
     * this.controler(c);
     * 
