...
public class Vente extends FactureCF {
    ...
    public Object validerObject(String u, Connection c) throws Exception {
        ...
        try {
            ...
            // MvtCaisse [] mvtCaisses = (MvtCaisse[]) CGenUtil.rechercher(mvtcaisse, null,
            // null, c, " ");
            // if(mvtCaisses.length>0 && (mvtCaisses[0].getIdOrigine()==null ||
            // mvtCaisses[0].getIdOrigine().isEmpty())){
            // // if(mvtCaisses[0].getIdOrigine()!=null &&
            // !mvtCaisses[0].getIdOrigine().isEmpty()) throw new Exception("");
